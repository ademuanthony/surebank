...
// @Success 200 {object} tenant.AccountResponse
...
func (h *Tenants) Read(ctx context.Context, w http.ResponseWriter, r *http.Request, params map[string]string) error {
	...
	res, err := h.Repository.Read(ctx, claims, tenant.AccountReadRequest{
		ID:              params["id"],
...
// @Produce  json
// @Security OAuth2Password
// @Param data body tenant.AccountUpdateRequest true "Update fields"
// @Success 204
// @Failure 400 {object} weberror.ErrorResponse
// @Failure 403 {object} weberror.ErrorResponse
// @Failure 500 {object} weberror.ErrorResponse
// @Router /accounts [patch]
func (h *Tenants) Update(ctx context.Context, w http.ResponseWriter, r *http.Request, params map[string]string) error {
	...
	var req tenant.AccountUpdateRequest
