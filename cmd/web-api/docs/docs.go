...
// 2020-01-31 10:19:29.386755 +0100 WAT m=+566.335842998
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/account.PagedResponseList"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/customer.PagedResponseList"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/transactions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter string, example: tx_type = 'deposit' and account_id = '1232-123dasf-324fdas-324423'",
                        "name": "where",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/transaction.PagedResponseList"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
