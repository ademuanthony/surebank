...
// 2020-01-27 10:11:52.070762 +0100 WAT m=+565.139104099
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/checklist.ChecklistResponse"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/checklist.ChecklistCreateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/checklist.ChecklistUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/deposits": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter string, example: account_id = '1232-123dasf-324fdas-324423'",
                        "name": "where",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/deposit.UpdateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/deposit.ArchiveRequest"
                        }
                    }
                ],
                "responses": {
