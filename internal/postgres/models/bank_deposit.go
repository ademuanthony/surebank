...
var BankDepositTableColumns = struct {
	ID            string
	BankAccountID string
	Amount        string
	Date          string
	...
	ID:            "bank_deposit.id",
	BankAccountID: "bank_deposit.bank_account_id",
	Amount:        "bank_deposit.amount",
	Date:          "bank_deposit.date",
}
...
type (
	...
	// This should almost always be used instead of []BankDeposit.
