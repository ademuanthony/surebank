...
var SaleItemTableColumns = struct {
	ID            string
	SaleID        string
	ProductID     string
	Quantity      string
	...
	ProductID:     "sale_item.product_id",
	Quantity:      "sale_item.quantity",
	UnitPrice:     "sale_item.unit_price",
	UnitCostPrice: "sale_item.unit_cost_price",
	StockIds:      "sale_item.stock_ids",
}
...
type (
	...
	// This should almost always be used instead of []SaleItem.
