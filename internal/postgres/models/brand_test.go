...
func testBrandToManySetOpProducts(t *testing.T) {
	var err error
...
func testBrandToManyRemoveOpProducts(t *testing.T) {
	var err error
...
var (
	brandDBTypes = map[string]string{`ID`: `character`, `Name`: `character varying`, `Code`: `character`, `Logo`: `character varying`}
	_            = bytes.MinRead
)
