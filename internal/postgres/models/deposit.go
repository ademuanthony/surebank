...
var DepositWhere = struct {
	...
	Amount:     whereHelperfloat64{field: "\"deposit\".\"amount\""},
...
func (o *Deposit) Account(mods ...qm.QueryMod) accountQuery {
...
func (o *Deposit) SalesRep(mods ...qm.QueryMod) userQuery {
	queryMods := []qm.QueryMod{
...
// loaded structs of the objects. This is for an N-1 relationship.
func (depositL) LoadSalesRep(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDeposit interface{}, mods queries.Applicator) error {
	var slice []*Deposit
	var object *Deposit
	...
	if singular {
		...
		foreign.R.SalesRepDeposits = append(foreign.R.SalesRepDeposits, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.SalesRepID == foreign.ID {
				...
				foreign.R.SalesRepDeposits = append(foreign.R.SalesRepDeposits, local)
				break
			}
		}
	}
...
func (o *Deposit) SetAccount(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Account) error {
	var err error
	if insert {
...
// SetSalesRep of the deposit to the related item.
// Sets o.R.SalesRep to related.
// Adds o to related.R.SalesRepDeposits.
func (o *Deposit) SetSalesRep(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
		if err = related.Insert(ctx, exec, boil.Infer()); err != nil {
			return errors.Wrap(err, "failed to insert into foreign table")
	...
	if related.R == nil {
		related.R = &userR{
			SalesRepDeposits: DepositSlice{o},
		}
	} else {
		related.R.SalesRepDeposits = append(related.R.SalesRepDeposits, o)
	}
