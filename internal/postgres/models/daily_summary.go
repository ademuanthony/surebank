...
var DailySummaryTableColumns = struct {
	Income      string
	Expenditure string
	BankDeposit string
	Date        string
}{
	Income:      "daily_summary.income",
	Expenditure: "daily_summary.expenditure",
	BankDeposit: "daily_summary.bank_deposit",
...
type (
	...
	// This should almost always be used instead of []DailySummary.
